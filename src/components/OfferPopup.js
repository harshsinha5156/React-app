...
//           </p>
//           <button className="bg-white text-indigo-700 font-medium py-2 px-4 rounded-lg hover:bg-indigo-50 transition-colors">
//             Claim Offer
//           </button>
//         </div>
...
const OfferPopup = ({ onClose }) => {
  ...
  const handleClaimOffer = () => {
    ...
    // Additional actions would typically go here:
    // - Apply discount code to the cart
    // - Redirect to products page
    // - Track analytics event
    // Example: window.location.href = '/products?discount=WELCOME20';
  };
