...
//                 <button 
//                   className={`absolute top-2 right-2 p-2 rounded-full z-50 ${isWishlisted ? 'bg-red-100 text-red-500' : 'bg-gray-100 text-gray-500'} hover:bg-red-100 hover:text-red-500`}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button 
          className="absolute top-4 right-4 bg-white rounded-full p-3 shadow-lg z-50 hover:bg-gray-100 transition-colors"
          onClick={onClose}
        >
        ...
        <button 
          className={`absolute top-4 left-4 rounded-full p-3 shadow-lg z-50 ${
            isWishlisted 
        ...
        <div className="md:flex pt-14"> {/* Added padding at top for buttons */}
          {/* Product Image */}
          <div className="md:w-1/2 p-6">
            <div className="h-80 rounded-xl bg-gray-100 flex items-center justify-center overflow-hidden">
              {product.imageUrl ? (
