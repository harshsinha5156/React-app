...
const QuickViewModal = ({ product, onClose, isWishlisted, toggleWishlist, addToCart }) => {
        ...
        <div className="relative">
          ...
          <div className="md:flex">
            ...
            <div className="md:w-1/2 p-6">
              ...
              <button className="w-full mt-4 py-3 border border-indigo-600 text-indigo-600 font-medium rounded-lg hover:bg-indigo-50 transition-colors">
